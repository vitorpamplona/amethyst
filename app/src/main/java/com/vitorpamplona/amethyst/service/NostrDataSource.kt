                ...
                try {
                    when (event) {
                        ...
                        is DeletionEvent -> LocalCache.consume(event)
                            ...
                            ReactionEvent.kind -> LocalCache.consume(
                                ReactionEvent(
                                    event.id,
                                    event.pubKey,
                                    event.createdAt,
                            ...
                            ReportEvent.kind -> LocalCache.consume(
                                ReportEvent(
                                    event.id,
                                    event.pubKey,
                                    event.createdAt,
                            ...
                            LnZapRequestEvent.kind -> LocalCache.consume(
                                LnZapRequestEvent(
                                    event.id,
                                    event.pubKey,
                                    event.createdAt,
                            ...
                            ChannelCreateEvent.kind -> LocalCache.consume(
                                ChannelCreateEvent(
                                    event.id,
                                    event.pubKey,
                                    event.createdAt,
                            ...
                            ChannelMetadataEvent.kind -> LocalCache.consume(
                            ...
                            ChannelMessageEvent.kind -> LocalCache.consume(
                                ChannelMessageEvent(
                                    event.id,
                                    event.pubKey,
                                    event.createdAt,
                            ...
                            ChannelHideMessageEvent.kind -> LocalCache.consume(
                            ...
                            ChannelMuteUserEvent.kind -> LocalCache.consume(
