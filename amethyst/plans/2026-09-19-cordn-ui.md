...
3. **Persistence.** An Android `CordnGroupStore` and `CordnKeyPackageStore` — encrypted at rest,
   like `AndroidMlsGroupStateStore`. Both interfaces exist; both actuals are missing. **Next.**
