...
1. Do we ship cordn to users at all before a licensed coordinator exists to test against (risk 2)?
   **Still open, and now the only thing between this plan and users.** Every stage below it has
   landed; all of it is verified against the fixture and none of it against a live coordinator.
