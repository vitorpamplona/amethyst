...
| Plan | Summary |
| ---- | ------- |
| [2026-09-22-user-contribution-studio.md](2026-09-22-user-contribution-studio.md) | Contribution Studio — a pinned "Your Amethyst Developer" chat where a user drives *their own* Claude Code (their account, their box, via `amy buzz agent up`) to build, test and propose Amethyst changes; phone is the control/review plane, merge stays on GitHub or gitworkshop. |
