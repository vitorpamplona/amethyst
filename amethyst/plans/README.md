...
| Plan | Summary |
| ---- | ------- |
| [2026-09-19-cordn-ui.md](2026-09-19-cordn-ui.md) | Every user-facing feature cordn-web has, mapped onto Amethyst — the account-level cordn runtime (the real gate), group list/chat/info screens, welcomes, join requests, message features and settings; recommends parallel cordn screens now and a shared chat surface later, and flags the 1009-vs-1010 edit-kind divergence. |
