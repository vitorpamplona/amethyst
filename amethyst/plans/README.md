...
| Plan | Summary |
| ---- | ------- |
| [2026-09-06-profile-overview-redesign.md](2026-09-06-profile-overview-redesign.md) | Profile page becomes an identity header + activity overview; every former tab (Notes, Replies, Media, Zaps, …) becomes its own screen with its own relay subscription. |
