...
val resSourceDir: Directory = rootProject.layout.projectDirectory.dir("amethyst/src/main/res")
...
abstract class GenerateAndroidResourceTable : DefaultTask() {
    ...
    private fun writeRClass(
        ...
        val out = File(kotlinOutputDir.get().asFile, "com/vitorpamplona/amethyst/R.kt")
        ...
        sb.append("package com.vitorpamplona.amethyst\n\n")
