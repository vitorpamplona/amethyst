...
| [2026-09-25-nostr-sql-profile.md](2026-09-25-nostr-sql-profile.md) | Read-only SQL over websockets: SQLite SELECT as the spec, `events`/`tags` virtual tables, parse + re-emit with per-session table substitution. Prototype parser/compiler/cursor landed and differential-fuzzed against SQLite; relay wiring, query interrupt and indexed tags open. |
