...
> **Status:** shipped — `experimental/clink/` ships pointers (NOffer/NDebit/NManage), `ClinkPointerParser`, events, and serialization tests; the plan header itself records the implementation as landed.
